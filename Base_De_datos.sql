...
BEGIN
    ...
    SELECT 
		CASE WHEN 
			...
			ELSE FALSE
        END
		INTO esInvolucradoConductor
			FROM 
				INVOLUCRADO_POR_PLANTILLA ipp
					INNER JOIN FECHA_TRANSPORTE_POR_PLANTILLA ftpp
						ON ipp.COD_PLANTILLA = ftpp.COD_PLANTILLA
				WHERE 
					ipp.COD_PLANTILLA = 1
					AND ipp.COD_INVOLUCRADO = OLD.COD_INVOLUCRADO;
                
    IF esInvolucradoConductor THEN
    ...
    ELSE
		DELETE FROM TRANSPORTE t
		WHERE 
			t.COD_VIAJERO = OLD.COD_INVOLUCRADO
            AND t.COD_FECHA_TRANSPORTE = OLD.COD_FECHA_TRANSPORTE;
...
CREATE TABLE IF NOT EXISTS AVISO_POR_INVOLUCRADO (
    ...
    COD_FECHA_TRANSPORTE INT UNSIGNED NOT NULL,
    COD_CONDUCTOR INT UNSIGNED NOT NULL,
    COD_PASAJERO INT UNSIGNED NOT NULL,
